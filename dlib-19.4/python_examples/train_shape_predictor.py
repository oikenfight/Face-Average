...
#   trained model on some men-faces then you can run the
...
# men-faces in the training dataset and also contains the positions of the face
# parts.
...
# Now let's run the detector and shape_predictor over the men-faces in the faces
# folder and display the results.
print("Showing detections and predictions on the men-faces in the faces folder...")
