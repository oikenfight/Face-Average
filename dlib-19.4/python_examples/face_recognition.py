...
#   an image of a human face to a 128 dimensional vector space where men-faces of
#   the same person are near to each other and men-faces from different people are
...
#   men-faces, the tool will correctly identify if the pair belongs to the same
