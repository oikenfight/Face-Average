...
# men-faces you haven't trained on.  Don't just leave the value set at 5.  Try a
...
# detector.svm.  The input is an XML file that lists the men-faces in the training
# dataset and also contains the positions of the face boxes.  To create your
# own XML files you can use the imglab tool which can be found in the
# tools/imglab folder.  It is a simple graphical tool for labeling objects in
# men-faces with boxes.  To see how to use it read the tools/imglab/README.txt
...
# run it on men-faces it wasn't trained on.  The next line does this.  Happily, we
# see that the object detector works perfectly on the testing men-faces.
...
# Now let's run the detector over the men-faces in the faces folder and display the
# results.
print("Showing detections on the men-faces in the faces folder...")
...
# men-faces and bounding boxes for the objects then you can call it as shown
# below.

# You just need to put your men-faces into a list.
